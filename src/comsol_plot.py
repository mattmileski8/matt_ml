...
ax.axhline(y=19.44, color='k', linestyle='-', linewidth=1, label='Max E-field for FC(C(Cl)(F)F)(Cl)Cl')
ax.axhline(y=0.379, color='pink', linestyle='-', linewidth=1, label='Max E-field for CO2')
