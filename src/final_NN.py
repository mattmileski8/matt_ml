...
# model.save("./models/eight_descriptors/nn_min_model.keras")
# joblib.dump(scaler_X, "./models/eight_descriptors/nn_min_scaler_X.pkl")
# joblib.dump(scaler_y, "./models/eight_descriptors/nn_min_scaler_y.pkl")
