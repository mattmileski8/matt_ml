...
# with open('./data/molecular_names_sorted.txt', 'r') as f:
#     lines1 = set(f.readlines())

# with open('./data/molecular_names_sorted_2.txt', 'r') as f:
#     lines2 = set(f.readlines())

# symmetric_difference = lines1.symmetric_difference(lines2)
# print("Lines not in both files:")
# for line in symmetric_difference:
#     print(line.strip())