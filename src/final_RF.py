...
# rmse_df.to_csv("./results/rf_test_rmse_per_loop_6.csv", index=False)
# print("Saved test RMSE per loop to ./results/rf_test_rmse_per_loop_6.csv")
...
joblib.dump(rf, "./models/six_descriptors/rf_min_model.pkl")
